...
// Add Crictimes floating widget
// ref: https://dwidget.crictimes.org/script.js?v=1.0.0
function addCrictimesWidget() {
    if (document.getElementById("floatCrictimes")) return;

    const floatDiv = document.createElement('div');
    floatDiv.id = 'floatCrictimes';
    ...
    floatDiv.innerHTML = `
        <iframe id="iframe" 
                src="https://dwidget.crictimes.org/index.html" 
    ...
    window.addEventListener('message', function (event) {
        ...
        if (event.data === 'open') {
            ...
            document.getElementById("floatCrictimes").style.background = "rgba(51,102,255,0.9)";
        } else if (event.data === 'close') {
            iframe.style.height = "66px";
            iframe.style.width = "200px";
            iframe.style.filter = "none";
            document.getElementById("floatCrictimes").style.background = "transparent";
        }
    });
}
